$(document).ready(function() {
	...
	/*전자서명하기, 도장이미지 업로드*/
	$("#contents .way li input, #btn_wrap2 a").on("click", function() {
		...
		$sign_wrap.find(".sign_tab").find("li").removeClass("on");
		$sign_wrap.find(".sign_tab").find("li").eq(aIdx).addClass("on");
		$sign_wrap.find(".sign_pan").find("li").removeClass("on");
		$sign_wrap.find(".sign_pan").find("li").eq(aIdx).addClass("on");
